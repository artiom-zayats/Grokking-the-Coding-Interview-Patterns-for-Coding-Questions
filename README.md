...
- Cyclic Sort (easy)
- Find the Missing Number (easy) - done
...
- Problem Challenge 3 - Find the First K Missing Positive Numbers (hard) * - done 
...
- Problem Challenge 1 - Tree Diameter (medium) * - done 
- Problem Challenge 2 - Path with Maximum Sum (hard) * - done
...
- Problem Challenge 1 - Evaluate Expression (hard) * - [no leetcode] - done
- Problem Challenge 2 - Structurally Unique Binary Search Trees (hard) *  - done / return
...
- Two Single Numbers (medium) * - done / but so so
- Complement of Base 10 Number (medium) -  done
