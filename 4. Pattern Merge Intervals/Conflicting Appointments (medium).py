...
def can_attend_all_appointments(intervals):
  #find if there is overlaping intervals return False
  #esle return True
  #sort intervals by startdate
...
#mycode
def can_attend_all_appointments1(intervals):
...
def main():
  ...
  print("Can attend all appointments: " + str(can_attend_all_appointments2([[4, 5], [2, 3], [3, 6]])))
